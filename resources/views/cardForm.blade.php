    ...
    <div class='row'>
        ...
        <div class='col-md-8'>
            ...
            <form accept-charset="UTF-8" action="/" class="require-validation"
                  ...
                  data-stripe-publishable-key="pk_test_51HrmZ3A2VCO2Q31fHStXUwimmzBxycdcWUkzJ9BbtVS8dfQ29mhHuhzypilchIy0Mny02F3ZtezP5PefQ3I5jsr700UbuTThvG"
                ...
                <div class='form-row'>
                    ...
                    <div class='col-xs-4 form-group expiration required'>
                        <label class='control-label'>YEAR</label> <input
                            class='form-control card-expiry-year' placeholder='2022'
                            size='4' type='text'>
                    </div>
                </div>
                <!-- <div class='form-row'>
